...
location.getLocationData = function (city) {
    let SQL ='SELECT * FROM searchLocation WHERE search_query = $1';
    let values = [city];
...
function cacheLocation(city , data){
    ...
    let SQL ='INSERT INTO searchLocation (search_query, formatted_query, latitude, longitude) VALUES ($1, $2, $3, $4) RETURNING *';
